...
public interface SSet<T> extends Iterable<T> {
	...
	/**
	 * Find the largest element in the SSet that is smaller than x. If x is
	 * null, return the largest element in the SSet
	 *
	 * @param x
	 * @return the largest element in the SSet that is smaller than x. If x is null
	 *         then the largest element in the SSet
	 */
	public T findLT(T x);
